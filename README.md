...
Class 1 Link: [Class 1](https://youtu.be/kiowbtjDrWo)

Class 2. 파이썬 웹 크롤러(Python Web Crawler)로 연속적인 크롤링 하기  
Class 2 Link: [Class 1](https://youtu.be/1772y3PtvA4)

Class 3. 파이썬 웹 크롤러(Python Web Crawler)로 자동 로그인 및 주요 정보 추출하기  
Class 3 Link: [Class 1](https://youtu.be/rsH2GGQviqQ)

Class 4. 셀레니움(Selenium)을 활용해 네이버 자동 로그인 및 메일 정보 가져오기  
Class 4 Link: [Class 1](https://youtu.be/UenvOvag0B4)
